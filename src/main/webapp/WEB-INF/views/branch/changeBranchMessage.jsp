			...
			<div class="row">
				...
				<div class="col-xs-7 col-xs-offset-2">
					<div class="center-branche-panel">
						...
						<input type="hidden" value="${ branchMessage.id }" name="id">
						<div class="row center-myBranches-up" style="border-bottom: 0px !important;">
							...
							<div class="col-xs-3">
								...
								<select class="form-control" name="tagName">
									<option value="" <c:if test="${ branchMessage.messageTag == null }">selected="selected"</c:if>>All</option>
								<c:forEach items="${ messageTags }" var="tag">
									<option value="${ tag.tagName }" <c:if test="${ branchMessage.messageTag!=null && branchMessage.messageTag.tagName == tag.tagName }">selected="selected"</c:if>>${ tag.tagName }</option>
								</c:forEach>
								</select>
								</div>
							</div>		
