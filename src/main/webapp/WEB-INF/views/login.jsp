		...
		<div class="lucency">
			<div class="row lucency-div">
				<div class="col-md-5">
					...
					<form method="post" onsubmit="return checkedAll()" id="login">
						...
						<p class="register">还没有账户？您可以在此 <a class="register" href='<c:url value='/user/newUser'/>'>注册</a> <a href="" class="forget">忘记密码</a></p>
					</form>
				</div>
			</div>
		</div>
